 ...
 */
public class HourWorkedAddEvent extends TimesheetAuditEvent {

    private static final String NEW_HOUR_WORKED_MESSAGE = "Added ${timeValue} hours on ${dateValue} against ${chargeCodes}";
    private final HoursWorked hoursWorked;

    @PersistenceConstructor
    public HourWorkedAddEvent(UUID id, String user, OurDateTime timestamp, String ipAddress, Employee employee, OurDateTime dateOfTimesheetComponent, HoursWorked hoursWorked) {
        super(id, user, timestamp, ipAddress, employee, dateOfTimesheetComponent, hoursWorked.getRevisionNumber());
        this.hoursWorked = hoursWorked;
    }

    public HourWorkedAddEvent(String user, OurDateTime timestamp, String ipAddress, HoursWorked hoursWorked) {
    ...
    public String getEventDescription() {
        return HourWorkedEventDescription.getEventDescription(hoursWorked, NEW_HOUR_WORKED_MESSAGE);
    }
