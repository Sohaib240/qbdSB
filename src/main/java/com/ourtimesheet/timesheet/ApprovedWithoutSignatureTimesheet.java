 ...
 */
public class ApprovedWithoutSignatureTimesheet extends Timesheet {

    @PersistenceConstructor
    public ApprovedWithoutSignatureTimesheet(UUID id, OurDateTime startDate, OurDateTime endDate, Employee employee, List<Signature> signatureList, Note note, int revisionNumber, Map<String, Boolean> exportedConfigurations) {
        super(id, startDate, endDate, employee, signatureList, note, revisionNumber, exportedConfigurations);
    }

    @Override
    public TimesheetStatus getStatus() {
        return TimesheetStatus.APPROVED_WITHOUT_SIGNATURE;
    }
    ...
    public Timesheet process(OurDateTime ourDateTime) {
        ...
        return new InProcessApprovedWithoutSignatureTimesheet(super.getId(), super.getStartDate(), super.getEndDate(), super.getEmployee(), super.getSignatureList(), super.getNote(), super.getRevisionNumber(), updatedConfigurations);
    }
    ...
    public Timesheet revise(OurDateTime processedTime) {
        throw new IllegalStateException("Approved without signature timesheet cannot be corrected");
    }
