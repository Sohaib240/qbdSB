...
public class ExportedWithoutSignatureTimesheet extends Timesheet {

    @PersistenceConstructor
    public ExportedWithoutSignatureTimesheet(UUID id, OurDateTime startDate, OurDateTime endDate, Employee employee, List<Signature> signatureList, Note note, int revisionNumber, Map<String, Boolean> exportedConfigurations) {
        super(id, startDate, endDate, employee, signatureList, note, revisionNumber, exportedConfigurations);
    }

    @Override
    public TimesheetStatus getStatus() {
        return TimesheetStatus.EXPORTED_WITHOUT_SIGNATURE;
    }
